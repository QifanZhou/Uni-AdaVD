...
class Switti(nn.Module):
    def __init__(
        ...
        # Useful for instrumentation/debug: identify which block a CrossAttention belongs to.
        for i, b in enumerate(self.blocks):
            if getattr(b, "cross_attn", None) is not None:
                b.cross_attn.adavd_block_idx = i
